...
<p align="center">
  <a href="#установка"><img src="https://img.shields.io/badge/версия-3.65-8ECA43?style=flat-square" alt="версия"></a>
...
Отдал за сутки больше половины от скачанного, отдачи не меньше 300 МБ, и
...
Когда набралась статистика по двум нодам, картина уточнилась. Нижний порог по
объёму отдачи в 300 МБ отсекает больше половины списка, и до проверки
пропорции реально доходят единицы:
