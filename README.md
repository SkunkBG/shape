...
<p align="center">
  <a href="#установка"><img src="https://img.shields.io/badge/версия-3.82-8ECA43?style=flat-square" alt="версия"></a>
...
1. **Минимальная скорость 0.05 Мбит/с** на все адреса нарушителя, которые
   видит эта нода, на 60 минут.
2. **Обрыв текущих соединений** через панель.

Без второго первое было бы бесполезным: уже установленные соединения просто
стали бы медленными, а человек оставался бы «в сети» до таймаута.
