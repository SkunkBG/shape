...
<p align="center">
  <a href="#установка"><img src="https://img.shields.io/badge/версия-3.41-8ECA43?style=flat-square" alt="версия"></a>
...
| Тихие сидеры | 35% за сутки, отдаёт сейчас, данными от 30% | то же |
...
| Отдача | Что это | Данными |
| --- | --- | --- |
| 976 МБ, пакет 1279 | раздача | **96%** |
| 347 МБ, пакет 780, макс 1539 | разговор плюс одно вложение | **1%** |

Разрыв такой, что порог можно ставить где угодно в середине. Стоит **30%** —
с запасом на смешанные окна, где человек одновременно говорит и отдаёт.
