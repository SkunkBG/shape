...
<p align="center">
  <a href="#установка"><img src="https://img.shields.io/badge/версия-3.80-8ECA43?style=flat-square" alt="версия"></a>
...
записывается как `guard_exempt`, чтобы при желании можно было посмотреть.
...
перекрытие руками: `panel set --limit-min 720`. Тогда вернётся и старый
недостаток.
