...
<p align="center">
  <a href="#установка"><img src="https://img.shields.io/badge/версия-3.63-8ECA43?style=flat-square" alt="версия"></a>
...
От пропорции, размера пакета и протокола признак не зависит вовсе. Это делает
его самым устойчивым из всех: ни склейка пакетов в ядре, ни QUIC, ни
шифрование на него не влияют.
