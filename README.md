...
Офис на одной подписке выглядит перепродажей: двадцать сотрудников бюро — это
двадцать адресов у одного пользователя панели, а правило считает адреса, а не
то, кем они являются.
...
Числовые ID из панели. Список задаётся целиком, а не дополняется. Проверить:
`panel show`, строка «Исключения».
