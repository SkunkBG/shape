...
<p align="center">
  <a href="#установка"><img src="https://img.shields.io/badge/версия-3.44-8ECA43?style=flat-square" alt="версия"></a>
...
| Тихие сидеры | 35% за сутки, отдаёт сейчас, данными от 70% | то же |
...
Порог стоит в середине разрыва — **70%**, тем же способом, каким выбран порог
отношения. Видеосвязь идёт пакетами под тысячу, поэтому доля у неё не единицы
процентов, а треть.
...
ста, потому что обе стороны шлют один и тот же поток.
