...
<p align="center">
  <a href="#установка"><img src="https://img.shields.io/badge/версия-3.40-8ECA43?style=flat-square" alt="версия"></a>
...
| Тихие сидеры | 35% за сутки, отдаёт сейчас, пакет до 1000 Б | то же |
...
📈 За сутки: ↓ 40.0 ГБ · ↑ 409.6 МБ (1%) · пакет вверх 150 Б
```
...
**Домашний пресет требует этого максимума от признака отношения.** Отдал за
сутки больше 35% от скачанного — мало; нужно ещё, чтобы пакет вверх хоть раз
дошёл до 1000 байт. Разговор до тысячи не доходит, сидер доходит в первое же
окно передачи.

Тысяча, а не шестьсот как у мгновенного признака: шестьсот выбирались для
среднего за десять секунд активной передачи, а на суточном максимуме
видеосвязь доходит до семисот.
