...
<p align="center">
  <a href="#установка"><img src="https://img.shields.io/badge/версия-3.32-8ECA43?style=flat-square" alt="версия"></a>
...
Telegram ID и номер в панели стоят отдельными строками и копируются одним
касанием — по ним человек ищется в панели за пару секунд. Имя берётся оттуда
же. Telegram-логин вида `@bashoyy` панель не хранит, поэтому его в карточке
нет.
